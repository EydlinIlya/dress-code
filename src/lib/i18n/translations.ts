...
const ru: Record<TranslationKey, string> = {
  ...
  "notFound.message": "Эта ссылка выглядит некорректной. Попросите организаторов прислать новую ссылку.",
  ...
  "match.ask": "Лучше спросите у организаторов",
  ...
  "playful.3": "Цвета уже выбраны. Вы выбираете наряд. Посмотрим, совпадут ли они.",
